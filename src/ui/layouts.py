...
class ClassificationLayout(QtWidgets.QGridLayout):
    def __init__(self):
        ...
        self.labelPredict1.setStyleSheet("background-color: rgba(65, 65, 65, 255) ; color: rgba(200, 200, 200, 255);")
        self.labelPredict1.setText("1:")

        self.labelPredict2 = QtWidgets.QLabel()
        self.labelPredict2.setStyleSheet("background-color: rgba(65, 65, 65, 255); color: rgba(200, 200, 200, 255);")
        self.labelPredict2.setObjectName("EUlabelPredict2")
        self.labelPredict2.setText("2:")

        self.labelPredict3 = QtWidgets.QLabel()
        self.labelPredict3.setStyleSheet("background-color: rgba(65, 65, 65, 255); color: rgba(200, 200, 200, 255);")
