...
def run_stream():
    ...
    os.mkdir(path = "./database/" + "gestures_seperate/" + str(letter) + str(current_folders).zfill(5))
    os.mkdir(path = "./database/" + "bbox_seperate/" + str(letter) + str(current_folders).zfill(5))
    os.mkdir(path = "./database/" + "labels_seperate/" + str(letter) + str(current_folders).zfill(5))
